...
-- Volcando estructura para tabla bancos.departamentos
...
-- Volcando datos para la tabla bancos.departamentos: ~32 rows (aproximadamente)
...
-- Volcando estructura para tabla bancos.municipios
...
-- Volcando datos para la tabla bancos.municipios: ~1.102 rows (aproximadamente)
